...
#
# make usbprogram = Download the hex file to the device by USB,
...
SRC = $(TARGET).c                                           \
		./Drivers/EEPROM/AAT25128A.c                      \
		./Drivers/AT90USB162/SPI.c                        \
		./Drivers/LEDs/LEDs.c	                          \
	  Descriptors.c                                     \
	  RingBuff.c                                        \
...
# Program the device by usb using dfu-program.  
